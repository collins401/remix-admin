...
import SettingMenuModal, { SettingDictTypeRefType } from './components/SettingDictType'
            ...
            {dictTypeList
              ...
              ?.map(item => (
                ...
                >
                  ...
                  <div
                    className={`space-x-2 hidden ${selectedDictType?.dictType === item.dictType ? '!block' : ''}`}
                  >
