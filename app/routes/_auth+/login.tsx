...
import { App, Button, ConfigProvider, Form, Input, message } from "antd";
...
export default function Login() {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 h-[100vh] flex-center">
        <div className="mx-auto rounded-md shadow-[-1px 4px 34px 0 rgba(138,185,255,.2)] p-2 md:p-10 md:pb-4 bg-white max-w-[450px]">
