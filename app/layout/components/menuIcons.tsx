...
const menuIcons = new Map([
	[
		'system',
		<Setting key="system" className="size-[22px]" fill="currentColor" />,
	],
	[
		'monitor',
	...
	['guide', <Link key="guide" className="size-[20px]" fill="currentColor" />],
	[
		'element',
		<Element key="element" className="size-[18px]" fill="currentColor" />,
	],
	['check', <Check key="check" className="size-[20px]" fill="currentColor" />],
]);
