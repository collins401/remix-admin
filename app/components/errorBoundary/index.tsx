				...
				<div className="lg:flex  items-center">
					<div className="flex-1">
						{error.message.includes(systemUpdateFlag) ? (
							<>
								<h2 className="text-primary text-2xl mb-7 font-500 ">
									系统更新了
								</h2>
								<p className="text-color/60 mb-0">
									很抱歉，中断了您当前的操作！
								</p>
								<p className="text-color/60 mb-2">
							...
							<>
								<h2 className="text-primary text-2xl mb-4 font-500 ">
									页面出错了
								</h2>
